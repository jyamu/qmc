...
#define QMCPLUSPLUS_VERSION_MAJOR  1

/* define the minor version */
#define QMCPLUSPLUS_VERSION_MINOR  0
...
#define QMCPLUSPLUS_BRANCH  6132

/* define the subversion last changed date */
#define QMCPLUSPLUS_LAST_CHANGED_DATE  "2013-12-18 10:06:41 -0500 (Wed, 18 Dec 2013)"
...
/* Define if sse41 support exists */
/* #undef HAVE_SSE41 */

/* Define if ssse3 support exists */
#define HAVE_SSSE3 1

/* Define if AVX support exists */
/* #undef HAVE_AVX */
...
/* Define the alignment of SIMD in byte*/
/* #undef SIMD_ALIGNMENT */

/* Define if FMA4 on x86 is supported */
/* #undef HAVE_FMA4 */
